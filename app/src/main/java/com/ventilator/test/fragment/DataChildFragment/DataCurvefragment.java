...
import com.ventilator.Tools.DrawView;
...
public class DataCurvefragment extends Fragment {
    ...
    @BindView(R.id.root)
    LinearLayout root;
    @BindView(R.id.tv_curve_showgkd)
    ImageView imggkd;
 ...
 DrawView view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        database();
        imggkd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(showgkd)
                {
                    showgkd=!showgkd;
                  imggkd.setBackgroundResource(R.drawable.cgq_float_yc);

                }
                else
                {
                    showgkd=!showgkd;
                    imggkd.setBackgroundResource(R.drawable.cgq_float_xs);
                }
                Draw();
            }
        });
