    ...
    public void WriteToSD(Context context) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String path = sd.getPath() + "/矿用通风机无线多参数测试仪/.报告模板";
                String path2 = sd.getPath() + "/矿用通风机无线多参数测试仪/测试报告";
                String path3 = sd.getPath() + "/矿用通风机无线多参数测试仪/.通风机性能曲线图";
                String path4 = sd.getPath() + "/矿用通风机无线多参数测试仪/软件";
        ...
        String filePath1;
        filePath1 = Environment.getExternalStorageDirectory() + "/矿用通风机无线多参数测试仪/软件";
